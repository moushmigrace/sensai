...
interface ThreadFeedProps {
    ...
    schoolId: string;
    courseId: string;
    /** Hide title row + primary “Ask” CTA (used inside Module Hub tabs). */
    listOnly?: boolean;
    /** Canonical hub page (`/hubs/[hubId]`) when registry id is known. */
    hubIdStr?: string;
}
...
export default function ThreadFeed({
    ...
    const askHref = hubIdStr
        ? `/school/${schoolId}/courses/${courseId}/hubs/${hubIdStr}`
